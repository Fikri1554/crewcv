...
<head>
    ...
    function displayOnLeave() {
        $("#idLoading").show();
        $.post('<?php echo base_url("dashboard/getDetailOnLeave"); ?>', {},
            function(data) {
                if (data) {
                    $("#idBodyTotalCrewOnLeave").empty();
                    $("#idBodyTotalCrewOnLeave").append(data.trNya);
                    $("#lblTotalCrewOnLeave").text(data.totalCrew);
    ...
    function getDetailCrewNameOnLeave(rankName) {
        $("#idLoading").show();
        $.post('<?php echo base_url("dashboard/getDetailCrewNameOnLeave"); ?>', {
                rank: rankName
            },
            function(data) {
                ...
                $("#idLblModalVesselDetail").text(rankName);
                $("#idLoading").hide();
            },
            "json"
        );
    ...
    <div class="container" style="background-color:;">
        <div class="form-panel" style="margin-top:5px;padding-bottom:15px;">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    <div class="panel-heading"
                        style="background-color:#078415;color:#FFFFFF;border:2px solid #000000;border-radius:30px;cursor:pointer;border-radius:30px;"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="idModalDetail">
                <div class="row">
                    <div class="col-md-5 col-xs-12">
                        <legend style="text-align: left;margin-bottom:0px;">
                            <label id="lblTotalCrewOnLeave">Total : <span id="idLblModal"></span></label>
                            <img id="idLoadingModal" style="display:none;"
                                src="<?php echo base_url('assets/img/loading.gif'); ?>">
                        </legend>
                        <div class="table-responsive">
                    ...
                    <div class="col-md-7 col-xs-12">
                        <div style="border:1px solid black;padding:10px;">
                            <legend style="text-align: left;margin-bottom:0px;">
                                <label id="lblModal">Rank : <span id="idLblModalVesselDetail"></span></label>
                            </legend>
                            <div class="table-responsive">
                                <table
                                    class="table table-border table-striped table-bordered table-condensed table-advance table-hover">
                                    <thead>
                                        <tr style="background-color: #16839B;color: #FFF;height:40px;">
                                            ...
                                            <th style="vertical-align: middle; width:37%;text-align:center;">Last Vessel
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody id="idBodyModalCrewDetail">
