                    ...
                    <div class="btn-group btn-group-justified" role="group" aria-label="Status Crew">
                        ...
                        <div class="btn-group" role="group">
                            <button type="button" onclick="searchData('onleave');" class="btn btn-success btn-xs"
                                title="On Leave" style="font-weight:bold;">On Leave</button>
                        </div>
                        <div class="btn-group" role="group">
                            <button type="button" onclick="searchData('nonaktif');" class="btn btn-warning btn-xs"
                                title="Non Aktif" style="font-weight:bold;">Non Aktif</button>
                        </div>
                        <div class="btn-group" role="group">
                            <button type="button" onclick="searchData('notforemp');" class="btn btn-danger btn-xs"
                                title="Not for Employeed" style="font-weight:bold;">Not for Emp.</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-8 col-xs-12">
                        ...
                        <div class="col-md-12 col-xs-12">
                            <div class="table-responsive" style="overflow-x: auto;white-space: nowrap;">
                                <table id="idTableCertificate"
                                    ...
                                    <thead>
                                        <tr style="background-color:#067780;color:#FFF;height:30px;">
                                            <th style="vertical-align:middle;text-align:center;" id="idTDCertOnboard"
                                                colspan="8">Panama</th>
                                        ...
                                        <tr style="background-color:#067780;color:#FFF;height:30px;"
                                            id="idTRCertOnboard">
                                            <th style="vertical-align:middle;width:12.5%;text-align:center;">Seaman Book
                                            </th>
                                            <th style="vertical-align:middle;width:12.5%;text-align:center;">Passport
                                            </th>
                                            <th style="vertical-align:middle;width:12.5%;text-align:center;">Endorsement
                                                Ijazah</th>
                                            <th style="vertical-align:middle;width:12.5%;text-align:center;">SSBT</th>
                                            <th style="vertical-align:middle;width:12.5%;text-align:center;">OTCBHS</th>
                                            <th style="vertical-align:middle;width:12.5%;text-align:center;">CTCBHS</th>
                                            <th style="vertical-align:middle;width:12.5%;text-align:center;">ERST</th>
                                            <th style="vertical-align:middle;width:12.5%;text-align:center;">Other</th>
                                        </tr>
                                    </thead>
                                    <tbody id="idTbody">
                                        <?php echo $trNya; ?>
